...
* Update R version dependency to R >= 4.2.0 because of `markovchain` package
* Bug fix: check the default value for `n` in `axn()` and `Axn()` is greater than or equal to 0.
