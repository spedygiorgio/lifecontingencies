...
ips55Act<-new("actuarialtable",x=ips55M@x,
lx=ips55M@lx,interest=0.02,name="IPS55M")
```
...
```{r pureend, tidy=TRUE}
#compute APV
APV=50e3*Exn(actuarialtable = ips55Act,
             x=30,n=35)
#compute Premium
P=APV/axn(actuarialtable = ips55Act,x=30,n=35)
c(APV,P)
```
