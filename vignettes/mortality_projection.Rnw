...
The code below fits the Lee Carter models as well as the Reinshaw Haberman (RH) and the Cairn Blake Down (CBD) one \cite{Cairns2007;Renshaw2006} ones. Some are long to be fit (expecialli the RH one)
...
#save(list=c("LCfit","CBDfit","RHfit"),file="StMoMoModels.RData",compress = "xz")
...
<<stmomo_rhplot,keep.source=TRUE, fig=TRUE>>=
plot(RHfit)
@
...
cbd_lifetable_1950<-probs2lifetable(probs=cbd_qx_1950,type = "qx",name = paste("CDB","1950","lt",sep="_"))
@
